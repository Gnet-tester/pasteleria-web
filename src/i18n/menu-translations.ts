...
export const menuTranslations: Record<string, Translations> = {
	// Group names
	Dulces: { en: 'Sweets', de: 'Süßes', fr: 'Sucré', ko: '디저트', zh: '甜点' },
	Desayunos: { en: 'Breakfasts', de: 'Frühstück', fr: 'Petits-déjeuners', ko: '아침 식사', zh: '早餐' },
	Bebidas: { en: 'Drinks', de: 'Getränke', fr: 'Boissons', ko: '음료', zh: '饮品' },
	...
	Brownie: { en: 'Brownies', de: 'Brownies', fr: 'Brownies', ko: '브라우니', zh: '布朗尼' },
	Kukis: { en: 'Kukis (cookies)', de: 'Kukis (Kekse)', fr: 'Kukis (cookies)', ko: '쿠키', zh: '曲奇' },
	Bowl: { en: 'Bowls', de: 'Bowls', fr: 'Bowls', ko: '보울', zh: '碗餐' },
	Tostas: { en: 'Toasts', de: 'Toasts', fr: 'Tartines', ko: '토스트', zh: '吐司' },
	Croissant: { en: 'Croissants', de: 'Croissants', fr: 'Croissants', ko: '크루아상', zh: '牛角包' },
	Tortitas: { en: 'Pancakes', de: 'Pfannkuchen', fr: 'Pancakes', ko: '팬케이크', zh: '松饼' },
	Sandwich: { en: 'Sandwich', de: 'Sandwich', fr: 'Sandwich', ko: '샌드위치', zh: '三明治' },
	Bocadillos: {
	...
	Extras: { en: 'Extras', de: 'Extras', fr: 'Suppléments', ko: '추가 옵션', zh: '附加项目' },
	Café: { en: 'Coffee', de: 'Kaffee', fr: 'Café', ko: '커피', zh: '咖啡' },
	...
	'Gise-lata': { en: 'Gise-lata', de: 'Gise-lata', fr: 'Gise-lata', ko: 'Gise-lata', zh: 'Gise-lata' },

	// Notes
	'3 panes': { en: '3 breads', de: '3 Brotsorten', fr: '3 pains', ko: '빵 3종', zh: '3种面包' },
	'Tea-tac': { en: 'Tea-tac', de: 'Tea-tac', fr: 'Tea-tac', ko: 'Tea-tac', zh: 'Tea-tac' },
	'Exclusivo en Gisela': {
	...
	Centeno: { en: 'Rye', de: 'Roggen', fr: 'Seigle', ko: '호밀', zh: '黑麦' },
	Oreo: { en: 'Oreo', de: 'Oreo', fr: 'Oreo', ko: '오레오', zh: '奥利奥' },
	Pistacho: { en: 'Pistachio', de: 'Pistazie', fr: 'Pistache', ko: '피스타치오', zh: '开心果' },
	'Cerveza Yunque': {
		en: 'Yunque beer',
		de: 'Yunque-Bier',
		fr: 'Bière Yunque',
	...
	'Vino tinto': { en: 'Red wine', de: 'Rotwein', fr: 'Vin rouge', ko: '레드 와인', zh: '红酒' },
	...
	Lotus: { en: 'Lotus', de: 'Lotus', fr: 'Lotus', ko: '로투스', zh: '罗特斯' },
	'Triki-Kuki': { en: 'Triki-Kuki', de: 'Triki-Kuki', fr: 'Triki-Kuki', ko: 'Triki-Kuki', zh: 'Triki-Kuki' },
	'Choco-sal': {
	...
	// Café
	Ristretto: { en: 'Ristretto', de: 'Ristretto', fr: 'Ristretto', ko: '리스트레토', zh: '意式浓缩短萃' },
	Espresso: { en: 'Espresso', de: 'Espresso', fr: 'Espresso', ko: '에스프레소', zh: '浓缩咖啡' },
	'Espresso doble': {
		en: 'Double espresso',
	...
	Americano: { en: 'Americano', de: 'Americano', fr: 'Americano', ko: '아메리카노', zh: '美式咖啡' },
	'Café con leche': {
		en: 'Coffee with milk',
		de: 'Kaffee mit Milch',
		fr: 'Café au lait',
	...
	Cappuccino: { en: 'Cappuccino', de: 'Cappuccino', fr: 'Cappuccino', ko: '카푸치노', zh: '卡布奇诺' },
	Machiato: { en: 'Macchiato', de: 'Macchiato', fr: 'Macchiato', ko: '마키아토', zh: '玛奇朵' },
	Bombón: { en: 'Bombón', de: 'Bombón', fr: 'Bombón', ko: '봄봉', zh: '炼奶浓缩咖啡' },
	'Flat white': { en: 'Flat white', de: 'Flat White', fr: 'Flat White', ko: '플랫 화이트', zh: '澳白咖啡' },
	'Iced coffee': { en: 'Iced coffee', de: 'Eiskaffee', fr: 'Café glacé', ko: '아이스 커피', zh: '冰咖啡' },
	...
	'Latte simple': { en: 'Plain latte', de: 'Latte', fr: 'Latte nature', ko: '심플 라떼', zh: '经典拿铁' },
	'Pink latte': { en: 'Pink latte', de: 'Pink Latte', fr: 'Pink Latte', ko: '핑크 라떼', zh: '粉色拿铁' },
	'Golden latte': {
		en: 'Golden latte',
		de: 'Golden Latte',
		fr: 'Golden Latte',
	...
	'Mango matcha': { en: 'Mango matcha', de: 'Mango-Matcha', fr: 'Matcha mangue', ko: '망고 말차', zh: '芒果抹茶' },
	'Fresa matcha': {
	...
	'Rooibos relax': { en: 'Relax rooibos', de: 'Rooibos Relax', fr: 'Rooibos relax', ko: '릴렉스 루이보스', zh: '舒缓博士茶' },
	'Jengibre y limón': {
		en: 'Ginger and lemon',
	...
	'Menta poleo': { en: 'Pennyroyal mint', de: 'Poleiminze', fr: 'Menthe poivrée', ko: '페니로얄 민트', zh: '薄荷茶' },
	Manzanilla: { en: 'Chamomile', de: 'Kamille', fr: 'Camomille', ko: '카모마일', zh: '洋甘菊' },
	'Té verde': { en: 'Green tea', de: 'Grüner Tee', fr: 'Thé vert', ko: '녹차', zh: '绿茶' },
	...
	'Té rojo': { en: 'Red tea', de: 'Roter Tee', fr: 'Thé rouge', ko: '홍차(루이보스)', zh: '红茶' },
	'English breakfast': {
	...
	'Té pakistaní': { en: 'Pakistani tea', de: 'Pakistanischer Tee', fr: 'Thé pakistanais', ko: '파키스탄 차', zh: '巴基斯坦茶' },
	'Frutos rojos': { en: 'Red berries', de: 'Rote Beeren', fr: 'Fruits rouges', ko: '레드베리', zh: '红莓' },

	// Infusiones frías
	'Tea-tac mango': { en: 'Tea-tac mango', de: 'Tea-tac Mango', fr: 'Tea-tac mangue', ko: 'Tea-tac 망고', zh: 'Tea-tac 芒果' },
	...
	'Tea-tac manzana': { en: 'Tea-tac apple', de: 'Tea-tac Apfel', fr: 'Tea-tac pomme', ko: 'Tea-tac 사과', zh: 'Tea-tac 苹果' },
	'Tea-tac limón': { en: 'Tea-tac lemon', de: 'Tea-tac Zitrone', fr: 'Tea-tac citron', ko: 'Tea-tac 레몬', zh: 'Tea-tac 柠檬' },

	// Otras bebidas
	'Agua mineral': { en: 'Mineral water', de: 'Mineralwasser', fr: 'Eau minérale', ko: '미네랄 워터', zh: '矿泉水' },
	'Agua de plástico': {
		en: 'Bottled water',
	...
	'Agua con gas': { en: 'Sparkling water', de: 'Sprudelwasser', fr: 'Eau gazeuse', ko: '탄산수', zh: '气泡水' },
	'Aquarius de naranja': {
		en: 'Orange Aquarius',
		de: 'Aquarius Orange',
		fr: 'Aquarius orange',
	...
	'Coca-cola': { en: 'Coca-Cola', de: 'Coca-Cola', fr: 'Coca-Cola', ko: '코카콜라', zh: '可口可乐' },
	'Coca-cola zero': { en: 'Coca-Cola Zero', de: 'Coca-Cola Zero', fr: 'Coca-Cola Zero', ko: '코카콜라 제로', zh: '零度可乐' },
	...
	'Mosto blanco': { en: 'White grape juice', de: 'Weißer Traubenmost', fr: 'Moût de raisin blanc', ko: '화이트 포도주스', zh: '白葡萄汁' },
	'Mosto rojo': { en: 'Red grape juice', de: 'Roter Traubenmost', fr: 'Moût de raisin rouge', ko: '레드 포도주스', zh: '红葡萄汁' },
	'Zumo de melocotón': { en: 'Peach juice', de: 'Pfirsichsaft', fr: 'Jus de pêche', ko: '복숭아 주스', zh: '桃汁' },
	'Zumo de piña': { en: 'Pineapple juice', de: 'Ananassaft', fr: "Jus d'ananas", ko: '파인애플 주스', zh: '菠萝汁' },
	'Zumo de naranja': { en: 'Orange juice', de: 'Orangensaft', fr: "Jus d'orange", ko: '오렌지 주스', zh: '橙汁' },
	...
	'Batido de choco': { en: 'Chocolate milkshake', de: 'Schoko-Milchshake', fr: 'Milkshake chocolat', ko: '초코 밀크셰이크', zh: '巧克力奶昔' },

	// Gise-lata
	Mango: { en: 'Mango', de: 'Mango', fr: 'Mangue', ko: '망고', zh: '芒果' },
	Manzana: { en: 'Apple', de: 'Apfel', fr: 'Pomme', ko: '사과', zh: '苹果' },
	Limón: { en: 'Lemon', de: 'Zitrone', fr: 'Citron', ko: '레몬', zh: '柠檬' },
	...
	'Leche de avena': { en: 'Oat milk', de: 'Hafermilch', fr: "Lait d'avoine", ko: '오트밀크', zh: '燕麦奶' },
	'Para llevar': { en: 'To go', de: 'Zum Mitnehmen', fr: 'À emporter', ko: '테이크아웃', zh: '外带' },
	'Con hielo': { en: 'With ice', de: 'Mit Eis', fr: 'Avec glaçons', ko: '얼음 추가', zh: '加冰' }
};
